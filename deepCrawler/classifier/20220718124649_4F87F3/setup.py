...
setuptools.setup(
    ...
    version='20220718124649_4F87F3',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - Text_classification:20220718124649_4F87F3
...
""",
    ...
    package_data={
        'Text_classification': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'Text_classification=Text_classification:cli',
        ],
    }
)
